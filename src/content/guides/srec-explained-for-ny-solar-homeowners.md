...
For a detailed walkthrough of how these numbers apply to your specific roof, usage profile, and tax situation, review the [Long Island example system builds](/case-studies/) or get a line-item proposal through our [Residential solar installation](/services/residential-solar-installation/) page. The [install process](/process/) page also walks through the incentive paperwork chain — NY-RETS registration, utility interconnection with PSEG-LI, and NYSERDA rebate coordination — so nothing falls through after the panels go up.
